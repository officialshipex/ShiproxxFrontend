          ...
          <table className="w-full border-collapse">
            ...
            <thead className="sticky top-0 z-20 bg-[#10BE3B]">
              <tr className="text-white bg-[#10BE3B] text-[12px] font-[600]">
                <th className="py-2 px-3 text-left bg-[#10BE3B] shadow-[0_1px_0_0_#10BE3B]">
                  ...
                  >
                    ...
                    <td className="py-2 px-3 whitespace-nowrap">
                      <div className="relative flex items-center gap-1 group">
                        <Link
                          ...
                          className="text-[#10BE3B] font-medium block hover:underline"
                        >
                          {order.orderId}
                        </Link>
                        <button
                    ...
                    <td className="py-2 px-3 whitespace-nowrap">
                      <div className="relative flex items-center gap-1 group max-w-fit">
                        <span
                          className="text-[#10BE3B] cursor-pointer font-medium hover:underline"
                    ...
                    <td className="py-2 px-3 whitespace-nowrap">
                      <span className="px-2 rounded py-0.5 text-[10px] bg-green-100 text-[#10BE3B]">
                        {order.status}
                      </span>
                    </td>
                    ...
                    <td className="py-2 px-3 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        {order.totalFreightCharges && (
                          ...
                          >
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-[#10BE3B]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><circle cx="12" cy="12" r="10" /><path d="M12 8v4m0 4h.01" strokeWidth="2" strokeLinecap="round" /></svg>
                          </div>
                        )}
                      </div>
                    </td>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-[600] text-[10px]">Order Id :<span className="text-[#10BE3B]">{row.orderId}</span></span>
