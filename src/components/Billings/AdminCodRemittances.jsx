              ...
              <tr>
                <th className="py-2 px-3">
                  <div className="flex justify-center items-center">
                    <input type="checkbox" checked={remitted.length > 0 && selectedIds.length === remitted.length} onChange={handleSelectAll} className="cursor-pointer accent-[#0CBB7D] w-3 h-3" />
                  </div>
                </th>
                  ...
                  return (
                    <tr key={index} className="border-t border-gray-200 hover:bg-green-50/30 transition-colors">
                      ...
                      <td className="py-2 px-3 leading-tight">
                        <div className="flex items-center gap-2 group">
                          <Link to={`/dashboard/order/tracking/${row.AWB_Number}`} className="text-[#0CBB7D] font-bold flex items-center gap-1 hover:underline">
                            {row.AWB_Number}

                          </Link>
                          <button onClick={() => handleCopy(row.AWB_Number, row.AWB_Number + '_awb')} className="p-1 hover:bg-green-100 rounded text-gray-400 hover:text-[#0CBB7D] transition-all opacity-0 group-hover:opacity-100">
                ...
                <div className="grid grid-cols-3 gap-2 mb-1 p-0.5 items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center justify-end gap-1">
                      <Link to={`/dashboard/order/tracking/${row.AWB_Number}`} className="text-[#0CBB7D] font-[600] truncate hover:underline text-[10px] max-w-[70px]">
                        {row.AWB_Number || "N/A"}
                      </Link>
                      <button onClick={() => handleCopy(row.AWB_Number, row.AWB_Number + '_m_m')}>
                        {copiedId === row.AWB_Number + '_m_m' ? <FiCheck className="w-2 h-2 text-[#0CBB7D]" /> : <FiCopy className="w-3 h-3 text-gray-400" />}
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-5 custom-scrollbar">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-9 px-3 font-[600] text-[12px] border border-gray-300 rounded-lg focus:outline-none focus:border-[#0CBB7D] transition-all text-gray-700 placeholder:text-gray-400"
